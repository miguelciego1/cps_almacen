...
class LabAlmDetalleingresoType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Alm\ControlStockBundle\Entity\LabAlmDetalleingreso'
        ));
    }
    ...
    {
        return 'alm_controlstockbundle_labalmdetalleingreso';
    }
